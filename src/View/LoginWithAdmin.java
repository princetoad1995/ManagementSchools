...
public class LoginWithAdmin extends javax.swing.JFrame {
    ...
    /**
     * Creates new form LoginWithAdmin
     */
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Dành cho quản trị viên");
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        if(new LoginDAOImpl().checkLoginAdmin(username, password)){
            ListStudent frmListStudent = new ListStudent();
